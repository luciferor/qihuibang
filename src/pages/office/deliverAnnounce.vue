  ...
  <div class="announce-box" style="height:100%;">
    <div class="announce-title">
      <Breadcrumb class="left-header" separator="＞">
        ...
        <BreadcrumbItem to="/pages/office/deliverAnnouce"><i class="deliver-icon"></i>发布公告</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="announce-content">
      ...
      <el-form ref="form" :model="form" label-width="80px" class="form-content-wrap">
        ...
        <el-form-item label="公告时间">
          <el-col :span="11">
            <el-date-picker type="date" placeholder="不设置则立即发布" v-model="form.date" style="width: 100%;"></el-date-picker>
          </el-col>
        </el-form-item>
