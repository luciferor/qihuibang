    ...
    <div class="office-title">
      <Breadcrumb class="left-header" separator="＞">
        <BreadcrumbItem to="/pages/office/officehome"><i class="officehome-icon"></i>办公应用</BreadcrumbItem>
           <BreadcrumbItem to="/pages/office/attendance"><i class="attendance-icon"></i>考勤</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="office-content">
     <div class="attendance-tip-logo">
      </div>
      <p class="attendance-tip">考勤打卡请到企汇邦APP</p>
...
.office-box {
  .office-title {
    ...
    .left-header {
      ...
      .attendance-icon {
        ...
        width: 15px;
        height: 21px;
        background-image: url("../../assets/office/icon_kaoqing_2.png");
        background-size: contain;
        background-position: center;
        background-repeat: no-repeat;
      }
  ...
  .office-content {
    ...
    .attendance-tip-logo {
      width: 158px;
      height: 206px;
      background-image: url("../../assets/office/img_kaoqingdaka.png");
      background-position: center;
      background-repeat: no-repeat;
      background-size: contain;
      margin-top: 50px;
