            ...
            <div class="userimg">
              <Poptip width="100" placement="right-end">
                ...
                <div class="api" slot="content">
                  ...
                  <div class="menulist">
                    <el-button @click="companyinfos" type="text">公司信息</el-button>
                  </div>
                  <div style="height: 1px; background-color: #ededed;"></div>
                  <div class="menulist">
                    <el-button @click="companyedit" type="text">企业设置</el-button>
                  </div>
                  <div class="menulist">
  ...
  methods: {
    ...
    saveeditinformations() {
      if (
        ...
        this.userinfo.oldpass == null ||
        this.userinfo.oldpass == undefined
      ) {
        this.error("旧密码不能为空");
        return;
      }
      if (
        ...
        this.userinfo.newpass == null ||
        this.userinfo.newpass == undefined
      ) {
        this.error("请输入新密码！");
        return;
      }
