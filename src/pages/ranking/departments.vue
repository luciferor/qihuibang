    ...
    <div class="ranking-content">
      <div class="ranking-wrap  today-ranking">
        ...
        <ul class="ranking-lists">
           <li class="ranking-item" v-for="(item,index) in todayRanking">
       ...
       <div class="ranking-wrap this-week-ranking">
        <div class="ranking-header">
          ...
          <ul class="ranking-lists">
           <li class="ranking-item" v-for="(item,index) in thisWeekRanking">
              <span class="order-number">{{item.key}}</span>
              <img v-if="index<=2" class="ueser-avatar" src='../../assets/ranking/icon_bumengxin.png'/>
              <span class="user-department">{{item.department}}</span>
               <p class="score-statistics"><span class="score-num">{{item.score}}</span>平均邦分</p>
       ...
       <div class="ranking-wrap this-month-ranking">
        <div class="ranking-header">
         ...
         <ul class="ranking-lists">
           <li class="ranking-item" v-for="(item,index) in thisMonthRanking">
              <span class="order-number">{{item.key}}</span>
              <img v-if="index<=2" class="ueser-avatar" src='../../assets/ranking/icon_bumengxin.png'/>
              <span class="user-department">{{item.department}}</span>
               <p class="score-statistics"><span class="score-num">{{item.score}}</span>平均邦分</p>
...
export default {
  ...
  methods: {
    ...
    historyRanking() {
      this.$router.push({ path: "/pages/ranking/departmentshistory" });
    },
    fuli() {
