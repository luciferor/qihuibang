    ...
    <div class="comtitle">
      <span class="fl">
        <Breadcrumb>
          ...
          <Breadcrumb-item>
              <Icon type="ios-pricetags-outline"></Icon>添加排班
          </Breadcrumb-item>
        </Breadcrumb>
      </span>
    </div>
    <div class="comcontent">
        <div class="inputbox">
            ...
            <div class="inputlinebox">
                ...
                <div class="input-content fr">
                    <div class="input-content-inputbox"><el-button @click="addlocation" class="colorpar" type="text">选址地址</el-button></div>
                    <div>
                        <div style="display:block; clear:both; background:red;" v-for="(item,index) in mapdata" :key="index">
                            <div class="fl">
                                <div><span>{{item.address}}</span><span style="color:gray; margin-left:20px;"><el-button @click="clearaddress(index)" type="text" style="color:#cccccc;"><i class="iconfont icon-lajitong"></i></el-button></span></div>
            ...
            <div class="inputlinebox">
                ...
                <div class="input-content fr">
                    <div class="input-content-inputbox"><el-button class="colorpar" @click="adduseres" type="text">{{scheduserids==''?'添加考勤用户':'已选择'}}</el-button></div>
                </div>
            </div>
            <!---------------------------------------------------------------------------------->
            <div class="inputlinebox">
  ...
  export default {
    ...
    methods:{
        ...
        savescheduinformations(){
            ...
            //提交数据
            let url = window.localStorage.api+"/check/addCheckWork";
