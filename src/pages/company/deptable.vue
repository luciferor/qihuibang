            ...
            <tr class="project-tr" style="display: table-cell;vertical-align:top;">
              <td>
                <div class="content">
                  ...
                  <el-input class="main-text" type="textarea" autosize placeholder="请输入当前工作" v-model="department.week_target" @blur="editDepartmentProject(department.id,department.week_target,department.proportion)"></el-input>
                </div>
              </td>
            </tr>
...
<style>
  ...
  .el-input__inner:hover {
    border:1px solid rgb(240, 240, 240)0ff !important;
  }
