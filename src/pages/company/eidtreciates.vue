  ...
  <div class="combox" style="height:100%;">
    ...
    <div class="comcontent">
      <div class="welfarecontent">
        <div class="reciates-setting-class">编辑赞赏</div>
                ...
                <div>
                  <div class="reciates-from-des-class">
                    ...
                    <span class="spanright">
                      <el-input disabled="true" placeholder="请输入要分配的邦分数量" v-model="input4" size="small">
                  ...
                  <div class="reciates-from-des-class">
                    ...
                    <span class="spanright">
                      <i-select disabled="true" placeholder="选择成员">
              ...
              <el-col :span="12" :xs="24">
                <div>
                  ...
                  <div class="reciates-from-des-class">
                    ...
                    <span class="spanrightone">
                      <DatePicker disabled="true" type="month" placeholder="请选择月份" style="width: 195px"></DatePicker>
                    </span>
                  </div>
                </div>
              </el-col>
