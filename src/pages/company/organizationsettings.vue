    ...
    <div class="comcontent">
      ...
      <div class="comrightlist fr">
        <div class="userlist-box">
          <ul>
            <li v-for="item in userlist" :key="item.id"><span class="menues posor" @click="positiones(item.id)"><div style="padding-left:10px; padding-top:2px;" class="fl"><img :id="'chimg'+item.id" width="15" height="15" src="../../assets/right.png" /></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style="padding-left:20px;" class="fl">{{item.name}}</div></span>
